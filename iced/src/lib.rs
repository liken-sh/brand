...
//!
//! The crate carries the mark, the palette, and the pulse the mark runs on. It
//! carries no type scale, no margins, and no layout. Those belong to the
//! display that draws the mark, and a ten-foot screen and a web page do not
//! share them.
